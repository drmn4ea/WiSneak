...
if __name__ == '__main__':
    ...
    p.add_argument("--response","-r",default=". 60 IN A 123.45.67.89",
                    metavar="<response>",
                    help="DNS response (zone format) (default: 123.45.67.89)")
    ...
    p.add_argument("--log-prefix",action='store_true',default=True,
                    help="Log prefix (timestamp/handler/resolver) (default: True)")
    args = p.parse_args()
